...
class wpdevart_org_chart_front {
	...
	public function include_scripts() {
		wp_enqueue_style('wpda_org_chart_front_css', wpda_org_chart_plugin_url . 'front/css/front_css.css', array(), '2.0');
		wp_enqueue_style('wpda_org_chart_front_popup_effects', wpda_org_chart_plugin_url . 'front/css/popup_effects.css', array(), '2.0');
		wp_enqueue_script('wpda_org_chart_front_js', wpda_org_chart_plugin_url . 'front/js/front_js.js', array(), '2.0');
		wp_register_script('wpda_org_chart_front_popup_js', wpda_org_chart_plugin_url . 'front/js/front_popup.js', array(), '2.0');
